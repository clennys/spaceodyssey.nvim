...
local highlights = {
  ...
  GalaxyBufferIcon = { fg = palette.color66, bg = palette.color1, },
  GalaxyBufferType = { fg = palette.color66, bg = palette.color1, },
  GalaxyDiagnosticError = { fg = palette.color3, bg = palette.color1, },
  GalaxyDiagnosticInfo = { fg = palette.color5, bg = palette.color1, },
  GalaxyDiagnosticWarn = { fg = palette.color2, bg = palette.color1, },
  GalaxyDiffAdd = { fg = palette.color7, bg = palette.color1, },
  GalaxyDiffModified = { fg = palette.color2, bg = palette.color1, },
  GalaxyDiffRemove = { fg = palette.color3, bg = palette.color1, },
  GalaxyFileFormat = { fg = palette.color66, bg = palette.color1, },
  GalaxyFileIcon = { fg = palette.color71, bg = palette.color1, },
  GalaxyFileName = { fg = palette.color66, bg = palette.color1, },
  GalaxyFirstElement = { fg = palette.color0, bg = palette.color1, },
  GalaxyGitBranch = { fg = palette.color66, bg = palette.color1, },
  GalaxyGitIcon = { fg = palette.color3, bg = palette.color1, },
  GalaxyLineInfo = { fg = palette.color66, bg = palette.color1, },
  GalaxyScrollBar = { fg = palette.color66, bg = palette.color1, },
  GalaxyViMode = { fg = palette.color2, bg = palette.color1, },
