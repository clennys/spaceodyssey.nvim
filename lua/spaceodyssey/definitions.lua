...
local highlights = {
  ...
  CmpItemAbbrDeprecated = { fg = palette.color11, bg = palette.color1, strikethrough = true},
  ...
  CmpItemKindVariable = { fg = palette.color10, bg = palette.color1, },
  CmpItemKindInterface = { fg = palette.color10, bg = palette.color1, },
  CmpItemKindText = { fg = palette.color10, bg = palette.color1, },
  CmpItemKindFunction = { fg = palette.color9, bg = palette.color1, },
  ...
  CmpItemKindEnum = { fg = palette.color8, bg = palette.color1, },
  ...
  DiagnosticInfo = { fg = palette.color12, },
  DiagnosticError = { fg = palette.color3, },
  DiagnosticHint = { fg = palette.color12, },
  DiagnosticWarn = { fg = palette.color9, },
